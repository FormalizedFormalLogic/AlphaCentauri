...
lemma Delta0_induction {P : (n : ℕ) → ArithmeticSemiformula ξ n → Prop}
    (hVerum : ∀ n, P n ⊤)
    (hFalsum : ∀ n, P n ⊥)
  ...
  |                 Hierarchy.and hp hq =>
    hAnd _ _ _ hp hq
      (Delta0_induction hVerum hFalsum hEQ hNEQ hLT hNLT hAnd hOr hBall hBex _ _ hp)
      (Delta0_induction hVerum hFalsum hEQ hNEQ hLT hNLT hAnd hOr hBall hBex _ _ hq)
  |                  Hierarchy.or hp hq =>
    hOr _ _ _ hp hq
      (Delta0_induction hVerum hFalsum hEQ hNEQ hLT hNLT hAnd hOr hBall hBex _ _ hp)
      (Delta0_induction hVerum hFalsum hEQ hNEQ hLT hNLT hAnd hOr hBall hBex _ _ hq)
...
open formulas. -/
lemma Delta0_induction_open {P : (n : ℕ) → ArithmeticSemiformula ξ n → Prop}
