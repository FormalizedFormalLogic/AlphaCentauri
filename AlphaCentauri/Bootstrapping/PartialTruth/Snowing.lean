...
private lemma eval_sigmaSatisfactionVec (p : M) (w : Fin k → M) :
  ...
  simp only [sigmaSatisfactionVec, Nat.succ_eq_add_one, Nat.reduceAdd, HierarchySymbol.Semiformula.val_mkSigma,
    ...
    Semiterm.val_operator, Matrix.comp₀, Tarski.Structure.numeral_eq_numeral, numeral_eq_natCast_app,
    ...
    Matrix.cons_val_succ, Tarski.Structure.eq_iff_eq, LogicalConnective.Prop.and_eq, exists_eq_right,
