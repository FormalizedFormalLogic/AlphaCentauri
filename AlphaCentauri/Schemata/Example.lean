...
theorem BSigma1_weakerThan_ISigma1 : 𝗕𝚺 1 ⪯ 𝗜𝚺 1 := BSigma_weakerThan_ISigma

theorem BSigma2_weakerThan_ISigma2 : 𝗕𝚺 2 ⪯ 𝗜𝚺 2 := BSigma_weakerThan_ISigma

theorem BSigma1_equiv_BPi0 : 𝗕𝚺 1 ≊ 𝗕𝚷 0 := BSigma_succ_equiv_BPi

theorem BSigma2_equiv_BPi1 : 𝗕𝚺 2 ≊ 𝗕𝚷 1 := BSigma_succ_equiv_BPi
...
theorem ISigma0_weakerThan_BSigma1 : 𝗜𝚺 0 ⪯ 𝗕𝚺 1 := ISigma_weakerThan_BSigma_succ

theorem ISigma1_weakerThan_BSigma2 : 𝗜𝚺 1 ⪯ 𝗕𝚺 2 := ISigma_weakerThan_BSigma_succ
